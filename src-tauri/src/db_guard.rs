...
fn get_dialog_texts(locale: &str) -> (&'static str, &'static str, &'static str, &'static str) {
    match locale {
        "zh-CN" => (
            "数据库版本不兼容",
            "下载历史数据库由更新版本的 FF Downloader 创建，\n\
             与当前版本不兼容。\n\n\
             继续使用需要重置下载历史记录。\n\
             已下载的文件不会受到影响。",
            "重置并启动",
        ...
        "zh-TW" => (
            "資料庫版本不相容",
            "下載歷史資料庫由更新版本的 FF Downloader 建立，\n\
             與目前版本不相容。\n\n\
             繼續使用需要重設下載歷史記錄。\n\
             已下載的檔案不會受到影響。",
            "重設並啟動",
        ...
        "ja" => (
            "データベースバージョンの不一致",
            "ダウンロード履歴データベースは新しいバージョンの FF Downloader で作成されたため、\
             このバージョンとは互換性がありません。\n\n\
        ...
        "ko" => (
            "데이터베이스 버전 충돌",
            "다운로드 기록 데이터베이스가 최신 버전의 FF Downloader에서 생성되어 \
             현재 버전과 호환되지 않습니다.\n\n\
        ...
        "ar" => (
            ...
            "تم إنشاء قاعدة بيانات سجل التنزيل بواسطة إصدار أحدث من FF Downloader \
        ...
        "bg" => (
            ...
            "Базата данни с история на изтеглянията е създадена от по-нова версия на FF Downloader \
        ...
        "ca" => (
            ...
            "La base de dades de l'historial de baixades va ser creada per una versió més nova de \
             FF Downloader i no és compatible amb aquesta versió.\n\n\
        ...
        "de" => (
            ...
            "Die Download-Verlaufsdatenbank wurde von einer neueren Version von FF Downloader \
        ...
        "el" => (
            ...
            "Η βάση δεδομένων ιστορικού λήψεων δημιουργήθηκε από μια νεότερη έκδοση του FF Downloader \
        ...
        "es" => (
            ...
            "La base de datos del historial de descargas fue creada por una versión más reciente de \
             FF Downloader y no es compatible con esta versión.\n\n\
        ...
        "fa" => (
            ...
            "پایگاه داده تاریخچه دانلود توسط نسخه جدیدتری از FF Downloader ایجاد شده \
        ...
        "fr" => (
            ...
            "La base de données de l'historique des téléchargements a été créée par une version \
             plus récente de FF Downloader et n'est pas compatible avec cette version.\n\n\
        ...
        "hu" => (
            ...
            "A letöltési előzmények adatbázisát a FF Downloader egy újabb verziója hozta létre, \
        ...
        "hi" => (
            ...
            "डाउनलोड इतिहास डेटाबेस FF Downloader के नए संस्करण से बनाया गया है \
        ...
        "id" => (
            ...
            "Database riwayat unduhan dibuat oleh versi FF Downloader yang lebih baru \
        ...
        "it" => (
            ...
            "Il database della cronologia download è stato creato da una versione più recente di \
             FF Downloader e non è compatibile con questa versione.\n\n\
        ...
        "nb" => (
            ...
            "Nedlastingshistorikkdatabasen ble opprettet av en nyere versjon av FF Downloader \
        ...
        "nl" => (
            ...
            "De downloaddatabase is aangemaakt door een nieuwere versie van FF Downloader \
        ...
        "pl" => (
            ...
            "Baza danych historii pobierania została utworzona przez nowszą wersję FF Downloader \
        ...
        "pt-BR" => (
            ...
            "O banco de dados do histórico de downloads foi criado por uma versão mais recente do \
             FF Downloader e é incompatível com esta versão.\n\n\
        ...
        "ro" => (
            ...
            "Baza de date a istoricului descărcărilor a fost creată de o versiune mai nouă \
             a FF Downloader și este incompatibilă cu această versiune.\n\n\
        ...
        "ru" => (
            ...
            "База данных истории загрузок была создана более новой версией FF Downloader \
        ...
        "th" => (
            ...
            "ฐานข้อมูลประวัติการดาวน์โหลดถูกสร้างโดย FF Downloader เวอร์ชันใหม่กว่า \
        ...
        "tr" => (
            ...
            "İndirme geçmişi veritabanı FF Downloader'in daha yeni bir sürümü tarafından \
        ...
        "uk" => (
            ...
            "Базу даних історії завантажень було створено новішою версією FF Downloader, \
        ...
        "vi" => (
            ...
            "Cơ sở dữ liệu lịch sử tải xuống được tạo bởi phiên bản FF Downloader mới hơn \
        ...
        _ => (
            ...
            "The download history database was created by a newer version of FF Downloader \
