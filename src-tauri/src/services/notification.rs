...
pub fn linux_notification_identity() -> LinuxNotificationIdentity {
    LinuxNotificationIdentity {
        app_name: "ffdownloader",
        icon: "ff-downloader",
        desktop_entry: "FFDownloader",
...
mod tests {
    ...
    fn linux_notification_identity_matches_gnome_desktop_entry() {
        let identity = linux_notification_identity();
        assert_eq!(identity.app_name, "ffdownloader");
        assert_eq!(identity.icon, "ff-downloader");
        assert_eq!(identity.desktop_entry, "FFDownloader");
